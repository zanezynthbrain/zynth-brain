# A Colour With a Voice

အသံရှိတဲ့ အရောင်

**ID:** COM-2026-BEAUTY-03  
**Format:** self-expression film  
**Linked campaign:** CMP-2026-BEAUTY-03  

## Film Brief

**Tension:** Makeup choice can become performative when shoppers feel they must copy a trend instead of describing a preferred look.
...
**Creative territory:** A shade can begin with a feeling, not a rule

## 12-Frame Storyboard

| # | Time | Visual action | Camera | Audio | Text | Purpose |
|---:|---|---|---|---|---|---|
| 1 | 00:00–00:03 | Opening macro: a proposed/TBC beauty-world detail introduces “A Colour With a Voice”. | Macro glide | Soft room tone | ZYNTH BEAUTY / proposed direction | Set the atmosphere without a product claim. |
...
| 10 | 00:33–00:37 | Bilingual line appears with Myanmar title. | Graphic dissolve | Soft music rise | အသံရှိတဲ့ အရောင် | Land bilingual identity. |
