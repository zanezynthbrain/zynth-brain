...
ပြန်စဖို့ ခွင့်ပြုချက်

**ID:** COM-2026-BEAUTY-10  
**Format:** CRM reactivation film  
**Linked campaign:** CMP-2026-BEAUTY-10  

## Film Brief

**Tension:** Past customers may have a changing routine, but reactivation can become intrusive when consent, contact rights and product facts are unclear.
...
**Creative territory:** The next routine begins with permission

## 12-Frame Storyboard

| # | Time | Visual action | Camera | Audio | Text | Purpose |
|---:|---|---|---|---|---|---|
| 1 | 00:00–00:03 | Opening macro: a proposed/TBC beauty-world detail introduces “Permission to Begin Again”. | Macro glide | Soft room tone | ZYNTH BEAUTY / proposed direction | Set the atmosphere without a product claim. |
...
| 10 | 00:33–00:37 | Bilingual line appears with Myanmar title. | Graphic dissolve | Soft music rise | ပြန်စဖို့ ခွင့်ပြုချက် | Land bilingual identity. |
