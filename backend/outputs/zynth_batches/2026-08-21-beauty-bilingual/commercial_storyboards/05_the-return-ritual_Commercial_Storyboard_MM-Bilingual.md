...
**ID:** COM-2026-BEAUTY-05  
**Format:** aftercare film  
**Linked campaign:** CMP-2026-BEAUTY-05  

## Film Brief

**Tension:** Sustainability language can become vague if a beauty brand has not confirmed what packaging, refill, return or aftercare proposition is actually available.
...
**Creative territory:** Care continues after the first use

## 12-Frame Storyboard

| # | Time | Visual action | Camera | Audio | Text | Purpose |
|---:|---|---|---|---|---|---|
| 1 | 00:00–00:03 | Opening macro: a proposed/TBC beauty-world detail introduces “The Return Ritual”. | Macro glide | Soft room tone | ZYNTH BEAUTY / proposed direction | Set the atmosphere without a product claim. |
...
| 10 | 00:33–00:37 | Bilingual line appears with Myanmar title. | Graphic dissolve | Soft music rise | ပြန်လာတဲ့ Ritual | Land bilingual identity. |
