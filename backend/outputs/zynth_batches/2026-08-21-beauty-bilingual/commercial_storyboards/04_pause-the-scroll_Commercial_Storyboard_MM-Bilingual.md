...
**ID:** COM-2026-BEAUTY-04  
**Format:** short-form manifesto  
**Linked campaign:** CMP-2026-BEAUTY-04  

## Film Brief

**Tension:** Short-form beauty content can pressure people to seek an instant result rather than understand a routine’s permitted use.
...
**Creative territory:** A pause can be more useful than a promise

## 12-Frame Storyboard

| # | Time | Visual action | Camera | Audio | Text | Purpose |
|---:|---|---|---|---|---|---|
| 1 | 00:00–00:03 | Opening macro: a proposed/TBC beauty-world detail introduces “Pause the Scroll”. | Macro glide | Soft room tone | ZYNTH BEAUTY / proposed direction | Set the atmosphere without a product claim. |
...
| 10 | 00:33–00:37 | Bilingual line appears with Myanmar title. | Graphic dissolve | Soft music rise | Scroll ကိုခဏရပ် | Land bilingual identity. |
