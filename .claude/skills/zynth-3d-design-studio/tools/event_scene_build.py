...
This script varies the PALETTE; stage_forms.py varies the stage ARCHITECTURE.

DESIGN DIRECTIONS (defined in event_scene_build_palettes.py, shared by both):
...
from event_scene_build_palettes import DIRECTIONS   # shared with stage_forms.py
